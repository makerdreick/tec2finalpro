                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group d-flex">
                                <div class="col-sm-6 d-flex">
                                    <input type="text" id="dniCliente" name="codigocliente" value="${c.getDni()}" class="form-control" placeholder="#Carnet">
                            ...
                            <div id="buscarProducto" class="form-group d-flex">
                                <div class="col-sm-6 d-flex">
                                    <input type="text" name="codigoproducto" value="${producto.getId()}" class="form-control" placeholder="Codigo-Producto">
                            ...
                            <div class="form-group d-flex">
                                <div class="col-sm-6 d-flex">
                                    <input type="text" name="precio" value="${producto.getPre()}" class="form-control" placeholder="Bs/.0.00">                                
                                </div>                           
                                <div class="col-sm-3">
