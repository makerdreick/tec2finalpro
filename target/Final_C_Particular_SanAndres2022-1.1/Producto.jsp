                    ...
                    <div class="card-body">
                        <form action="ControladorProducto?menu=Producto" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" value="${producto.getNom()}" name="txtDni" required class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Precio</label>
                                <input type="text" value="${producto.getPre()}" name="txtNombres"  required class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Stock</label>
                                <input type="text" value="${producto.getStock()}" name="txtTel" required class="form-control">
                            </div>
                           <div class="form-group">
                                <label>Estado</label>
